...
description: "Wikidata provides dumps of all the data that can be easily downloaded. I'll post something later once I've learned a bit more about it."
---
...
Here's more info: [Wikidata Database Download](https://www.wikidata.org/wiki/Wikidata:Database_download)